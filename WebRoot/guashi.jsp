...
<html>
  ...
  <body >
	...
	<div ><br/>
  	<center>
  	<h2>请挂失账户的信息</h2>
    <form name="mainform" action="AccountServlet?method=3&sign=3" method="post" onsubmit="return on_submit()">
    <table width="442" border="0" cellspacing="1" cellpadding="1" height="320">
  		<tr height="50"  align="center">
    		<td align="left" valign="middle">&nbsp;挂失账号：</td>
    		<td><input type="text" name="accid"></td>
  		</tr>
  		<tr height="50"  align="center">
    		<td align="left" valign="middle">&nbsp;客户身份证号：</td>
    		<td><input type="text" name="accsfzh"></td>
  		</tr>
  		<tr height="50"  align="center">
    		<td align="left" valign="middle">&nbsp;挂失账户密码：</td>
    		<td><input type="password" name="accpwd"></td>
  		</tr>
  		<tr height="50"  align="center">
    		<td colspan=2 >
    			<input class=bu type="submit" value="挂失 "></td>
