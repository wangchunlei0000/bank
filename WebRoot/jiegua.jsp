...
body{
  ...
  <body >
	...
	<div >
  	<center><br/>
  	<h2>请输入解除挂失账户的信息</h2>
    <form name="mainform" action="AccountServlet?method=10&sign=16" method="post" onsubmit="return on_submit()">
    <table width="459" border="0" cellspacing="1" cellpadding="1" height="259">
  		<tr height="50"  align="center">
    		<td align="left" valign="middle">解除挂失账号：</td>
  		...
  		<tr height="50"  align="center">
    		<td colspan=2>
    			<input class=bu type="submit" value="解挂 "></td>
