...
body{
   background:url("img/bbb.jpg");
    ...
    function on_submit(){
    	...
    	22:"吉林",23:"黑龙江",31:"上海",32:"江苏",33:"浙江",34:"安徽",35:"福建",36:"江西",37:"山东",41:"河南",42:"湖北",
  ...
  <body>
	...
	<div >
  	...
  	<br/>
  	<h2>请输入客户信息</h2>
    <form name="mainform" action="AccountServlet?method=1&sign=1" method="post" onSubmit="return on_submit()">
    <table width="428" border="0" cellspacing="1" cellpadding="1" height="406">
    	...
    	<tr height="45"  align="center">
  		...
  		<tr height="45"  align="center">
    		<td colspan="2">
    			<input class=bu type="submit" value=" 开户  ">&nbsp;&nbsp;&nbsp;
