...
<html>
  <head>
	...
	<%
	    ...
	    //Integer number=(Integer)session.getAttribute("jilu");
	    //System.out.println("number "+number);
	    //Long accid=(Long)session.getAttribute("accid");
	    //List tradeList=tradeCtrl.JxTrade(accid,number); 
...
body{
  ...
  <div >
  <form name="mainform" action="main.jsp" method="post" onsubmit="return check();">
  <table width="620" border="0" cellspacing="0" cellpadding="0" >
  	  	
  	<tr>
    	<td colspan="2" align="center"><h4>取款成功！该账户的取款明细如下</h4></td>
  	</tr>
  	<tr>
