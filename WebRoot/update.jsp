...
a{
  ...
  <center><br/><br/><br/>
  <div >
    <h2>修改客户信息请输入客户如下信息:</h2>
    <form name="mainform" action="AccountServlet?method=4&sign=8" method="post" onsubmit="return on_submit()">
    <table width="451" border="0" cellspacing="1" cellpadding="1" height="193">
    	<tr height="50"  align="center">
  		...
  		<tr height="50"  align="center">
    		<td colspan="2"><input class=bu type="submit" name="submit" value=" 确定  "></td>
  		</tr>
  	</table>
  	</form>
  	</div>
