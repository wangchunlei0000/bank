...
<script language="javascript" type="text/javascript">
	function check(){
  	    var tno=document.getElementById("accid").value;
...
<div class="bef" style="top: 186px; left: 304px; height: 435px;">
    <form name="form1" method="post" action="UserServlet?method=100&sign=100" onSubmit="return check()">
			<div class="login-head">
				<br><center><h1>&nbsp;<font size="7">用户登录</font></h1></center>
				</div><br/>
				<div class="login-head1">
				<a href="adminlogin.jsp">管理员登录</a><br><br><a href="login.jsp">柜员登录</a><br/><br/>
				<font size="5">用 户 名&nbsp;</font>
				<input type="text" name="accid" id="accid" placeholder="请输入用户名"><br></div><br>
    			<font size="5">密&nbsp;&nbsp;&nbsp;码&nbsp;</font> 
    			 <input type="password" name="accpwd" id="accpwd" placeholder="请输入密码"><br><br/>
